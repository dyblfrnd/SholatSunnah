...
import com.example.sholatsunnah.Deskripsi;
import com.example.sholatsunnah.R;
...
//        todo : inisialisasi
        ...
        istikhoroh = findViewById(R.id.istkhoroh);
        tahiyyatul_masjid = findViewById(R.id.tahiyyatulmasjid);
        sholat_syuruq = findViewById(R.id.syuruq);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.dhuha:
                ...
                dhuha.putExtra("sunnah", "https://.or.id/44198-fikih-shalat-dhuha.html");
                startActivity(dhuha);
                break;
            ...
            case R.id.syuruq:
                ...
                sholat_syuruq.putExtra("sunnah", "https://aitarus.com/sholat-syuruq-isyraq/");
